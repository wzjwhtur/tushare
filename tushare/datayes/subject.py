...
class Subject():
    ...
    def NewsByTickers(self, secID='', secShortName='', ticker='', beginDate='', endDate='', exchangeCD='', field=''):
        ...
        code, result = self.client.getData(
            vs.NEWSBYTICKERS % (secID, secShortName, ticker, beginDate, endDate, exchangeCD, field))
        return _ret_data(code, result)
    ...
    def ThemesByTickers(self, secID='', secShortName='', ticker='', beginDate='', endDate='', exchangeCD='', field=''):
        ...
        """
        code, result = self.client.getData(
            vs.THEMESBYTICKERS % (secID, secShortName, ticker, beginDate, endDate, exchangeCD, field))
        return _ret_data(code, result)
    ...
    def SectorThemesByTickers(self, secID='', secShortName='', ticker='', beginDate='', endDate='', exchangeCD='',
                              field=''):
        """
        ...
        """
        code, result = self.client.getData(
            vs.SECTORTHEMESBYTICKERS % (secID, secShortName, ticker, beginDate, endDate, exchangeCD, field))
        return _ret_data(code, result)

    def WebThemesByTickers(self, secID='', secShortName='', ticker='', beginDate='', endDate='', exchangeCD='',
                           field=''):
        """
        ...
        """
        code, result = self.client.getData(
            vs.WEBTHEMESBYTICKERS % (secID, secShortName, ticker, beginDate, endDate, exchangeCD, field))
        return _ret_data(code, result)
    ...
    def NewsHeatIndex(self, beginDate='', endDate='', exchangeCD='', secID='', secShortName='', ticker='', field=''):
        ...
        """
        code, result = self.client.getData(
            vs.NEWSHEATINDEX % (beginDate, endDate, exchangeCD, secID, secShortName, ticker, field))
        return _ret_data(code, result)

    def NewsSentimentIndex(self, beginDate='', endDate='', exchangeCD='', secID='', secShortName='', ticker='',
                           field=''):
        """
        ...
        """
        code, result = self.client.getData(
            vs.NEWSSENTIMENTINDEX % (beginDate, endDate, exchangeCD, secID, secShortName, ticker, field))
        return _ret_data(code, result)
